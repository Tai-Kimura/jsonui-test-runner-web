 ...
 */
export function classifyFailure(error: unknown): FailureReason | undefined {
  if (error === undefined || error === null) return undefined;
  if (error instanceof CaseNotFoundError) return 'invalid-test';
  if (error instanceof NotAScreenTestError) return 'invalid-test';
  return 'other';
}
